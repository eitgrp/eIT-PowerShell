...
$Product="Firefox"
$EvergreenName="MozillaFirefox"
$EvergreenType="msi"  # msi or exe
$EvergreenChannel="Stable"
$EvergreenLanguage="en-GB"
...
If ($Prod) {
    ...
    $evergreenapp = Get-EvergreenApp -Name $EvergreenName -AppParams @{Language=$EvergreenLanguage} | Where-Object { $_.Channel -eq "Current" -and $_.Architecture -eq $targetarchitecture -and $_.type -eq $EvergreenType } | `
