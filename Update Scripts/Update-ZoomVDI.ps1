#!ps
#timeout=600000
## Install / Update TeraTerm
$Product="Zoom Client for VDI"
$EvergreenName="ZoomVDI"
$EvergreenType="msi"  # msi or exe
$EvergreenPlatform="VDIClient"
...
If ($Prod) {
    ...
    $evergreenapp = get-evergreenapp -Name $EvergreenName | Where-Object { $_.Type -eq $EvergreenType -AND $_.Platform -eq $EvergreenPlatform } | Select-Object -First 1
    # Evergreen just report "Latest" for the version number, have to fudge this
    [version]$ProductVersion = "999.99.99.99"
